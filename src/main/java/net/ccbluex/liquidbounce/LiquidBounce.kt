...
object LiquidBounce {
    ...
    // Client information
    const val CLIENT_NAME = "Reason"
    const val CLIENT_VERSION = "0.1"
    const val CLIENT_CREATOR = "CCBlueX,WaWa"
    ...
    fun startClient() {
        ...
        ClientUtils.getLogger().info("Finished loading Reason in ${System.currentTimeMillis() - lastTick}ms.")
