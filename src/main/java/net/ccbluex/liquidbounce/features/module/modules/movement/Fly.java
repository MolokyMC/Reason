...
public class Fly extends Module {
        ...
        switch (mode.toLowerCase()) {
            ...
            case "watchdog":
                ...
                if (expectItemStack == -1) {
                    LiquidBounce.hud.addNotification(new Notification("Fly","The fly requires slime blocks to be activated properly.", NotifyType.INFO,1500,500));
                    break;
                }
    ...
    public void onMotion(final MotionEvent event) {
        ...
        if (modeValue.get().equalsIgnoreCase("grimdamage")) {
