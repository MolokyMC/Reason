...
public abstract class MixinMinecraft {
    ...
    public void getRenderViewEntity(CallbackInfoReturnable<Entity> cir) {
        if (renderViewEntity instanceof EntityLivingBase && RotationUtils.serverRotation != null && thePlayer != null) {
            ...
            if (killAura.getTarget() != null && Rotations != null){
                if (Rotations.getHeadValue().get()) {
                    entityLivingBase.rotationYawHead = yaw;
                    entityLivingBase.prevRotationYawHead = yaw;
                }
            }
            if (killAura.getTarget() != null && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (scaffold.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (scaffold.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (disabler.getCanRenderInto3D() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (disabler.getCanRenderInto3D() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (spinBot.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (spinBot.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (chestAura.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (chestAura.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (fly.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (fly.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (bowAimbot.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (bowAimbot.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (fucker.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (fucker.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
            if (nuker.getState() && Rotations != null && Rotations.getHeadValue().get()) {
                entityLivingBase.rotationYawHead = yaw;
                entityLivingBase.prevRotationYawHead = yaw;
            }
            if (nuker.getState() && Rotations != null && Rotations.getBodyValue().get()) {
                entityLivingBase.renderYawOffset = yaw;
                entityLivingBase.prevRenderYawOffset = yaw;
            }
        }
